Feature: hidden links
  ...
  Scenario: New ticket link is shown to a user with permission
    Given "user@ticketee.com" can view the "project 1" project
    And "user@ticketee.com" can "create tickets" in the "project 1" project
  ...
  Scenario: Delete ticket link is shown to a user with permission
    Given "user@ticketee.com" can view the "project 1" project
    And "user@ticketee.com" can "delete tickets" in the "project 1" project
    And I am signed in as "user@ticketee.com"
    When I follow "project 1"
    And I follow "Shiny!"
